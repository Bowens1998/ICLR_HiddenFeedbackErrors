...
def main():
    ...
    for g in range(6):
        ...
        with tempfile.TemporaryDirectory(prefix='jrs-fiber-reaccept-') as td:
            ...
            cmd=[sys.executable,str(Path(__file__).with_name('accept_shuffled_fiber_rollout.py')),'--run',str(t)]
