...
def main():
    ...
    for group in range(6):
        ...
        assert ac['status']=='PASS_ALL8_MATCHED_ACTION_NUMPY_RECONSTRUCTIONS' and ac['report_sha256']==sha(d/'report.json') and ac['source_sha256']==sha(Path(__file__).with_name('accept_task_coordinate_matched_native.py'))
